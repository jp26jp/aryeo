...
| Phase 4 - Docs And Examples | Publish client-library docs and safe examples. | docs/, mkdocs.yml, examples/ | Docs use ReZEN-style navigation and strict builds pass. | Users cannot discover the client shape. |
